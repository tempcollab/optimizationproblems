...
$s_Q=\deg Q$ precisely when that branch attains the denominator maximum for the
right-hand perturbation; otherwise $s_Q=0$.
\end{theorem}
...
\begin{proposition}[Diagnostic for the record; proved in Section~\ref{sec:record}]
\label{prop:record-intro}
...
inert.  The values in this diagnostic are fine-grid evaluations; they are not used as
