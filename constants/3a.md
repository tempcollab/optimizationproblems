...
| $1.1754$ | [R18cert] | Base-$21$ digit construction, $A=\{0,2,\dots,10\}$, $d=100$, $T=187$ (carry-free). Exact strict beat $C_{3a}\ge 5877/5000$ via big-integer power-inequality wedge ($N_-^{q}\ge N_+^{q}(2M+1)^{p}$); reviewer-verified bit-for-bit. |
