...
- **Restricted class — cap bodies (dimension $3$).** The illumination number of every $3$-dimensional cap body is exactly $6$, confirming the illumination conjecture for this restricted class; this does not improve the general bound $H_3 \le 14$. <a href="#AKP2026">[AKP2026]</a>
...
- <a id="AKP2026"></a>**[AKP2026]** Arman, Andrii; Kaire, Jaskaran Singh; Prymak, Andriy. *Illumination number of 3-dimensional cap bodies.* Discrete Mathematics **349**(7) (2026), 115025. [arXiv:2507.08712](https://arxiv.org/abs/2507.08712).

## Contribution notes

Prepared with assistance from ChatGPT 5.2 Pro. Restricted-class cap-body context and the [AKP2026] reference added with assistance from an AI research agent; the cited source was verified against its arXiv/journal record.
