...
| $1.1760055927978140$ | [this repo, 2026] | Same base-$21$ gapped-digit family pushed to depth $d=110$, cap $T=210$; exact-integer-counting certificate `constants/3a/certificate/certify_3a.py 110 210`. Reviewer-verified R2. |
| $1.1774273905511207$ | [this repo, 2026] | Same base-$21$ gapped-digit family pushed to depth $d=150$, cap $T=285$; exact-integer-counting certificate `constants/3a/certificate/certify_3a.py 150 285`. Reviewer-verified R3 (interval-ln lower endpoint $\theta_{iv}.a \le$ true $\theta$ at 4000-bit; DP byte-identical to the R2-verified version). A machine-checked Lean proof of the continuum-endpoint half ($\ge 1.175$) is banked at `constants/3a/lean/C3a.lean`. |
