...
\emph{monic}-preserving exponent (degree alone is not maximal at $a=5$ on this side).
In both cases $a=5$ is the maximal exponent preserving the \emph{monic leading
coefficient} of $Q^*$, and $R_0,R_2$ are the instances $a=5$.
\end{proposition}
